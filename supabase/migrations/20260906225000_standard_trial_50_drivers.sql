-- Migration: Set Standard Plan Free Trial Quota to 50 drivers and 4 managers
-- Date: 2026-09-06

-- 1. Update existing companies currently on standard trial to 50 drivers and 4 managers
...
-- 2. Update register_workspace for all new workspace registrations (50 drivers, 4 managers)
...
-- 3. Update activate_free_trial for manual activations (50 drivers, 4 managers)
