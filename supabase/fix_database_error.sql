-- 1. Ensure all columns actually exist in the profiles table!
...
-- 2. Fix the region constraint. The app uses 'MY', 'TH', 'SG', but the DB only allowed 'MY', 'PT'
...
-- 3. Replace the handle_new_user trigger again just to be 100% safe
